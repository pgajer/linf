...
The figure below illustrates L∞ DCSTs in a bundled set of 766 gut microbiome
samples from the American Gut Project (AGP). The subset was deliberately
stratified to include every sample assigned to four selected uncommon DCSTs;
the remaining slots are a seed-42 simple random sample from the eligible
background. Phenotypes do not influence selection. The object is suitable for
demonstrating the package workflow, but its phenotype frequencies, effect
sizes, and p-values must not be interpreted as population estimates because
...
- **L-Infinity CSTs: From Normalization to a Gut Demonstration** — a
  ...
  DCSTs, and descriptive exploration of the bundled AGP gut data.
