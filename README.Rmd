...
* Ties resolve to the **first** maximum (as in `max.col(..., ties.method = "first")`)
...
If you use this package, please cite the Linf paper (citation entry will be added here upon publication).
