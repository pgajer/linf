...
\midrule
Gut support-schedule perturbation & Using the existing full-AGP raw-lineage size audit, a \(\pm25\%\) perturbation around the manuscript support schedule 50/25/25/25 changed hierarchy granularity but preserved high pre-absorb sample coverage at shallow depths. -25\%: thresholds 38/19/19/19; retained lineages 45/170/221/123; pre-absorb retained sample share 96.8\%/83.3\%/52.1\%/16.8\%. nominal: thresholds 50/25/25/25; retained lineages 40/141/154/89; pre-absorb retained sample share 96.2\%/81.3\%/47.4\%/14.4\%. +25\%: thresholds 63/31/31/31; retained lineages 35/115/114/64; pre-absorb retained sample share 95.3\%/79.0\%/43.8\%/12.1\%. & The support schedule controls naming granularity and should be treated as an explicit modeling choice, not as a hidden clustering parameter. \\
\midrule
