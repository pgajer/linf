...
the main text. In the discovery cohort, the clearest and most
biologically coherent branches were IBD, IBS, autoimmune disease, and
two additional non-IBD examples:
...
stories are coherent but not equally mature. IBD remains the strongest
and best-validated inflammatory branch,
...
for IBS and the non-IBD branches. AGP phenotypes are also self-reported and cross-sectional, so
...
compare directly. The added acid-reflux and seasonal-allergy results
suggest that this framework can also generalize beyond the core
inflammatory phenotypes when the downstream analysis remains selective,
biologically grounded, and appropriately cautious about external
generalization.
