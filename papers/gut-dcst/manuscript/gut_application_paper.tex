...
depletion. The clearest and most biologically coherent branches were
...
The absorb policy changed only 3.8\% of depth-1 assignments relative to
the earlier rare-policy view, but the difference became much more
important with increasing depth: 18.5\% of samples were reassigned at
depth 2, 52.0\% at depth 3, and 71.6\% at depth 4. Biologically, this
is the level at which the absorb policy matters most, because deeper
rare branches are merged into larger named lineages instead of being
collapsed into one generic rare bucket. Omnibus phenotype-by-depth
...
(ii) the proportion of samples reassigned relative to the rare-policy
view at depths 1--4, and (iii) depth-wise omnibus effect sizes for the
key phenotype branches.}}
...
Bayesian lineage-level estimates.
...
rare IBD enterobacterial branches.
...
discovery analyses reported here.
