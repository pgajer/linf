"""Legacy figure helper for an older AGP IBD follow-up view.

The current manuscript uses canonical local-QZA SILVA AGP outputs and the
overview / supplement figures generated by `build_ibd_results_overview_figure.py`.
"""
